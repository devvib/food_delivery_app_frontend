    ...
    return (
        <nav className="navbar navbar-expand-lg navbar-dark bg-success position-sticky" style={{ boxShadow: "0px 10px 20px black", filter: 'blur(20)', position: "fixed", zIndex: "10", width: "100%" }}>
            <div className="container-fluid">
                <Link className="navbar-brand fs-1 fst-italic" to="/">JustFood</Link>
                ...
                <div className="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    {!localStorage.getItem("token") ?
                        ...
                        <div className="d-flex align-items-center">
                            <div className="btn btn-light text-success mx-2" onClick={loadCart}>
                            ...
                            <button onClick={handleLogout} className="btn btn-light text-success ms-2">Logout</button>
                        </div>
                    }
                </div>
            </div>
